...
export function GrowthEngineTab({ 
  ...
  return (
    <div className="space-y-6">
      {/* Sub-tab Navigation */}
      <div className="overflow-x-auto no-scrollbar flex flex-nowrap sm:flex-wrap gap-1.5 p-1.5 rounded-2xl bg-slate-100 dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
        <button
          onClick={() => setSubTab("f4f")}
          className={`whitespace-nowrap flex-shrink-0 flex items-center gap-2 px-3.5 sm:px-4 py-2 rounded-xl text-xs font-bold transition ${
            subTab === "f4f"
        ...
        >
          ...
          <span>Blue Tick F4F Radar (500 Goal)</span>
        </button>
        ...
        >
          ...
          <span>Viral Hook Optimizer</span>
        </button>
      ...
      {subTab === "f4f" && (
        <div className="space-y-6">
          ...
          <div className="p-5 sm:p-6 rounded-2xl bg-gradient-to-br from-blue-900/40 via-indigo-950/40 to-slate-900 border border-blue-500/30 backdrop-blur-xl shadow-lg relative overflow-hidden space-y-4">
            <div className="flex items-center justify-between flex-wrap gap-3">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className="px-4 py-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-white text-xs font-bold flex items-center gap-2 transition disabled:opacity-50 shadow-md shadow-emerald-500/25"
                >
          ...
          {f4fGrowthPosts && f4fGrowthPosts.length > 0 && (
            <div className="p-4 sm:p-5 rounded-2xl bg-gradient-to-r from-amber-950/20 via-orange-950/20 to-slate-900 border border-amber-500/30 shadow-md space-y-4">
