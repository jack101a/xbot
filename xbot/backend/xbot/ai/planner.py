...
async def plan_session(
    ...
    user_prompt += (
        ...
        "   - DYNAMIC LENGTH & OPENINGS: Vary your lengths naturally (from short 1-sentence takes to multi-line observations). Use genuine human emotions (sarcasm, shock, excitement, witty observations). NEVER start every post or reply with 'If...' or hypothetical statements!\n"
        ...
        "   - EMOJI & CASING: Every sentence MUST use standard Sentence case capitalization. Double line breaks (\\n\\n) between observations and questions. Use emojis strictly for emotional expression or facial subtext (😭, 🫠, 🤦‍♂️, 😮‍💨, 🤝, 🔥, 👀). Strictly NEVER use topic-labeling emojis (no 🍿 for movies, no 🏴‍☠️ for One Piece, no ⌚ for watches, no 🤖 for tech). Use 0 emojis for deadpan or technical takes.\n"
