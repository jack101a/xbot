...
async def test_execute_browser_action_routing():
    ...
    with patch("xbot.browser.actions.registry.LikeTweet") as MockLike:
    ...
    with patch("xbot.browser.actions.registry.ReplyToTweet") as MockReply:
        mock_instance = MagicMock()
    ...
    with patch("xbot.browser.actions.registry.QuoteTweet") as MockQuote:
        mock_instance = MagicMock()
    ...
    with patch("xbot.browser.actions.registry.ComposePost") as MockPost:
        mock_instance = MagicMock()
