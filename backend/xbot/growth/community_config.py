...
COMMUNITY_NICHE_CONFIG = {
    ...
    "tech": {
        ...
        "curated_peers": [
            ...
            {"handle": "LinusEkenstam", "display_name": "Linus Ekenstam", "followers": 12000, "following": 2500, "bio": "AI, design, and future interfaces. Exploring what is next."},
            {"handle": "svpino", "display_name": "Santiago", "followers": 14000, "following": 1200, "bio": "Coding, AI, Machine Learning. Building software that scales."},
            {"handle": "minchoi", "display_name": "Min Choi", "followers": 9500, "following": 1800, "bio": "AI tools, workflows, visual generation, prompt design."},
            {"handle": "bentossell", "display_name": "Ben Tossell", "followers": 11000, "following": 2100, "bio": "Building in public, AI explorations, tools & software."},
            {"handle": "alexalbert__", "display_name": "Alex Albert", "followers": 8500, "following": 900, "bio": "Prompt engineering, LLM interfaces, developer tools."},
        ]
    },
    "ai": {
        ...
        "curated_peers": [
            ...
            {"handle": "saboo_shubham_", "display_name": "Shubham Saboo", "followers": 9200, "following": 1100, "bio": "Generative AI, LLM architectures, and agent frameworks."},
            {"handle": "skirano", "display_name": "Pietro Schirano", "followers": 13500, "following": 2200, "bio": "AI founder, design systems, visual prompting."},
            {"handle": "bindureddy", "display_name": "Bindu Reddy", "followers": 14500, "following": 1900, "bio": "CEO of Abacus.AI • Deep learning and foundation models."},
            {"handle": "altryne", "display_name": "Altryne", "followers": 8700, "following": 1400, "bio": "AI experiments, creative code, diffusion workflows."},
            {"handle": "bilawalsidhu", "display_name": "Bilawal Sidhu", "followers": 9900, "following": 1600, "bio": "Spatial computing, neural rendering, generative 3D."},
        ]
    },
    "growth_mutuals": {
        ...
        "curated_peers": [
            ...
            {"handle": "TechGrowthMutual", "display_name": "Tech Creators Connect", "followers": 3100, "following": 2950, "bio": "Verified tech creators follow back circle. Build your network!"},
            {"handle": "AIBigMutuals", "display_name": "AI Mutuals Hub", "followers": 4200, "following": 3800, "bio": "Blue tick creators supporting blue tick creators. 100% follow back!"},
            {"handle": "OpenSourceMutuals", "display_name": "Dev & Code Mutuals", "followers": 2600, "following": 2400, "bio": "GitHub builders, indie hackers, Python & TypeScript mutuals."},
            {"handle": "VerifiedCircleX", "display_name": "Verified Creators Circle", "followers": 5500, "following": 4800, "bio": "Connecting verified accounts for active engagement & mutual growth."},
        ]
    },
    "indian_creators": {
        ...
        "curated_peers": [
            ...
            {"handle": "kirat_tw", "display_name": "Harkirat Singh", "followers": 14000, "following": 600, "bio": "100xDevs founder • Full-stack, open source, and Web3 builder.", "is_indian": True},
            {"handle": "tanaypratap", "display_name": "Tanay Pratap", "followers": 12500, "following": 900, "bio": "Invact founder • Tech educator, building products that educate millions.", "is_indian": True},
            {"handle": "varunmayya", "display_name": "Varun Mayya", "followers": 13800, "following": 800, "bio": "AI founder, content creator, exploring future tech & robots.", "is_indian": True},
            {"handle": "hvpandya", "display_name": "Hardik Pandya", "followers": 8900, "following": 1100, "bio": "Design engineer, UI/UX systems, product design in India.", "is_indian": True},
            {"handle": "rahulsinghai", "display_name": "Rahul Singhai", "followers": 6700, "following": 2200, "bio": "Tech builder, AI enthusiast, building in public from Bengaluru.", "is_indian": True},
        ]
    }
}
