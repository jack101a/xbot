...
async def human_click(
    ...
    try:
        await element.click(timeout=3500)
    except Exception:
        try:
            # Fallback 1: Force click through transparent overlays/backdrops
            await element.click(force=True, timeout=2500)
        except Exception:
            try:
                # Fallback 2: Direct DOM event dispatch
