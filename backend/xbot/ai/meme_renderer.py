...
render_storyboard_4panel = render_4panel_storyboard


def render_visual_spec_to_image(spec_data: dict[str, Any], output_path: str | None = None) -> str:
    """Lazy-loaded dispatcher to avoid circular import."""
    from xbot.ai.meme_infographic import render_meme_from_spec
    return render_meme_from_spec(spec_data, output_path=output_path)
