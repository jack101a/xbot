...
def _build_sniper_user_prompt(
    target_tweet: dict[str, Any],
    preferred_angle: str | None = None,
    persona: Persona | None = None,
) -> str:
    """Constructs the user prompt containing target tweet details, top comments, media descriptions, worldview directives, and schema instructions."""
    ...
    if persona:
        worldview_section = build_worldview_prompt_section(
            persona=persona,
            context_text=text,
