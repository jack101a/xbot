...
def post_process_formatted_content(
    ...
    6. Max 2 hashtags enforcement.
    7. Hashtag spacing fix (#GodValleyThe -> #GodValley The).
    8. Strips any leftover outer quotes.
    """
    ...
    text = AntiAIGatekeeper.enforce_max_hashtags(text, max_tags=2)
    text = fix_hashtag_spacing(text)
